...
const detailPage = () => {
  ...
  return (
    <>
      <div className="padding overflow-hidden w-full md:w-2/3 lg:w-full mx-auto my-auto py-[30px] flex lg:flex-row flex-col items-center justify-center gap-8 md:gap-[60px] lg:gap-[100px] h-full pt-0 sm:h-[200%] md:h-[calc(100vh-78px)] lg:h-[calc(100vh-88px)]">
        {currentProduct && (
          <motion.div
            variants={container2}
            initial="initial"
            animate="show"
            className="w-full flex lg:flex-row flex-col items-center justify-center gap-8 md:gap-[60px] lg:gap-[100px] h-full"
          >
